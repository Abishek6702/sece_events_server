module.exports = function(params) {
  ...
  var staffDetails = params.staffDetails;
  ...
  return '<div style="font-family:Arial,sans-serif;max-width:600px;margin:auto;border:1px solid #e0e0e0;border-radius:8px;padding:20px;background-color:#f9f9f9;">' +
    '<div style="text-align:center;margin-bottom:20px;border-bottom:3px solid #27ae60;padding-bottom:10px;"><h2 style="color:#27ae60;margin:0;">Audio Staff Allocated</h2></div>' +
    '<p>Dear Organizer,</p>' +
    '<p>An Audio staff member has been allocated for your upcoming event at <strong>' + venueName + '</strong>.</p>' +
    '<h3 style="color:#444;border-bottom:1px solid #ddd;padding-bottom:5px;">Event Details</h3>' +
    '<div style="background:#e8f8f5;border-left:4px solid #27ae60;padding:15px;margin:20px 0;border-radius:4px;">' +
    ...
    '<p style="text-align:center;margin-top:30px;color:#888;font-size:14px;">Regards,<br><a href="https://srieshwarevents.com" target="_blank" style="color:#27ae60;text-decoration:none;font-weight:bold;">Sri Eshwar Events</a></p>' +
    '</div>';
};
